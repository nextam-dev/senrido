 ...
 *
 */
public class SenridoLoginUrlAuthenticationEntryPoint extends LoginUrlAuthenticationEntryPoint {

	public SenridoLoginUrlAuthenticationEntryPoint (String loginFormUrl) {
		super(loginFormUrl);
	}
