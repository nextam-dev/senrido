...
import jp.nextam.senrido.annotation.MessageName;
import jp.nextam.senrido.validation.constraints.BiteSize;

/**
 *
 */
@Entity(listener = MEmployeeListener.class)
...
public class MEmployee {
    ...
    /**  */
    @Column(name = "contract_employee_flg")
    @MessageName("契約社員")
    Boolean contractEmployeeFlg;

    /**  */
    @Column(name = "authority_employee_flg")
    @MessageName("権限社員")
    Boolean authorityEmployeeFlg;

    /**  */
    @Column(name = "jomu_use_employee_flg")
    @MessageName("乗務記録利用フラグ")
    Boolean jomuUseEmployeeFlg ;
    ...
    /**
     * Returns the contractEmployeeFlg.
     *
     * @return the contractEmployeeFlg
     */
    public Boolean getContractEmployeeFlg() {
        return contractEmployeeFlg;
    }

    /**
     * Sets the contractEmployeeFlg.
     *
     * @param contractEmployeeFlg the contractEmployeeFlg
     */
    public void setContractEmployeeFlg(Boolean contractEmployeeFlg) {
        this.contractEmployeeFlg = contractEmployeeFlg;
    }

    /**
     * Returns the authorityEmployeeFlg.
     *
     * @return the authorityEmployeeFlg
     */
    public Boolean getAuthorityEmployeeFlg() {
        return authorityEmployeeFlg;
    }

    /**
     * Sets the authorityEmployeeFlg.
     *
     * @param authorityEmployeeFlg the authorityEmployeeFlg
     */
    public void setAuthorityEmployeeFlg(Boolean authorityEmployeeFlg) {
        this.authorityEmployeeFlg = authorityEmployeeFlg;
    }
     ...
     * @return the contractEmployeeFlg
     */
    public Boolean getJomuUseEmployeeFlg() {
        return jomuUseEmployeeFlg;
    }
     ...
     * @param contractEmployeeFlg the contractEmployeeFlg
     */
    public void setJomuUseEmployeeFlg(Boolean jomuUseEmployeeFlg) {
        this.jomuUseEmployeeFlg = jomuUseEmployeeFlg;
    }
	 ...
	 * @return hanakoUse
	 */
	public Boolean getHanakoUse() {
		return hanakoUse;
	}

	/**
	 * @param hanakoUse セットする hanakoUse
	 */
	public void setHanakoUse(Boolean hanakoUse) {
		this.hanakoUse = hanakoUse;
	}
