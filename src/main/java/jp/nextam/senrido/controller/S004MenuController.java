...
import jp.nextam.senrido.form.S004MenuForm;
 ...
 */
@Controller
public class S004MenuController {

	@Autowired
	private Environment eivironment;

	@RequestMapping(value="/s004Menu", method = RequestMethod.GET)
    public String getMenu(@ModelAttribute("form") S004MenuForm form, Model model) {
		// 認証した情報を取得する
