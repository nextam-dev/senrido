 ...
 */
@Controller
public class J002MenuController {

	@Autowired
	private Environment eivironment;

	private static final Log log = LogFactory.getLog(J002MenuController.class);

	@RequestMapping(value = "/j002Menu", method = RequestMethod.GET)
