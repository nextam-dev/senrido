...
WHERE
    ...
    /*%end*/
    /*%if customerSerch.visitDateStart != null && customerSerch.visitDateEnd != null */
	AND (tv.visit_date BETWEEN /* customerSerch.visitDateStart */'a' AND /* customerSerch.visitDateEnd */'a')
	/*%end*/
